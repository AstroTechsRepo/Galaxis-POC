...
| Reverse proxy | Caddy | 2.8 | Config déclarative, HTTPS facile pour la cible prod, léger |
| IAM | Keycloak | 26.0 | OIDC OAuth2 complet, JWKS, PKCE natif, mature |
...
|---|---|---|---|
| Maturité ORM | ✅ Eloquent | Partiel — SQLAlchemy (verbeux) | ❌ aucun built-in |
| Courbe d'entrée TPE | ✅ Docs FR énormes | Moyen | Trop bas niveau |
| Migrations natives | ✅ artisan migrate | Partiel — Alembic à part | ❌ Knex/typeorm à choisir |
| Auth/middleware | ✅ built-in | Partiel — à coder | Partiel — à coder |
| Job queue (v2) | ✅ Horizon natif | Partiel — Celery | Partiel — Bull |
...
| OIDC complet | ✅ | Partiel | ✅ | ✅ |
| Admin UI riche | ✅ | Partiel | ❌ | ✅ |
| Multi-realm | ✅ | ❌ | Partiel — via projects | Partiel — payant |
| Communauté FR | ✅ forte | Faible | Faible | n/a |
