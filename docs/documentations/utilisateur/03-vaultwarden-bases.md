...
> **Important** : dans la version actuelle (POC), Vaultwarden a son **propre compte** séparé de Galaxis. Vous devez créer votre compte Vaultwarden la première fois.
...
2. Renseignez :
   ...
   - **Mot de passe maître** : **TRÈS IMPORTANT** — choisissez un mot de passe **fort** que vous **ne devez jamais oublier**

> **Attention** : si vous oubliez votre mot de passe maître Vaultwarden, **personne ne peut le récupérer**. C'est le prix de la sécurité totale. Notez-le **dans un endroit sûr hors ligne** (papier dans un tiroir fermé à clé, par exemple) la première fois.
...
> **Note POC** : la fonctionnalité de partage avancée (organisations Vaultwarden) demande quelques étapes que votre prestataire vous accompagnera à mettre en place la première fois. Une fois configurée, le partage marche comme suit :
