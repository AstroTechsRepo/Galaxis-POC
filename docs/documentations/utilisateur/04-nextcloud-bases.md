...
> ⚠️ **Note POC** : comme Vaultwarden, Nextcloud a son **propre compte** dans la version actuelle. Demandez à votre prestataire vos identifiants Nextcloud lors de la mise en route.
...
> ⚠️ **Attention** : un lien partagé **sans expiration ni mot de passe** est accessible par n'importe qui qui obtient l'URL. Configurez toujours **au moins une protection** pour les documents sensibles.
