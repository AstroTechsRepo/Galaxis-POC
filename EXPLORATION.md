...
> Document produit en Phase 0. Source de vérité = slides de soutenance + `CLAUDE_CODE_PROMPT.md`.
...
> ⚠️ La slide 10 originale parlait de « HTTPS TLS · CA locale · ports :443 :8443 :9443 :10443 ». Le brief Claude Code impose une simplification pour la démo : **HTTP via tunnel SSH** (cf. section 7).
